...
- **Content fidelity**: NEVER add text, symbols, or decorative elements that don't exist in Figma. No → arrows, • bullets, ▶ triangles, or other typography that wasn't designed. All text must come from Figma `text_content` fields or `docs/copy_guide.md`.
