...
1. **Gather context**: Read the error log, stack trace, or reproduction steps provided by the user. Check recalled **review lessons** (native memory; passed in your prompt when you run as a subagent) for known recurring bug patterns that may match.
