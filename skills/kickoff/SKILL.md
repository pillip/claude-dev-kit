...
**planner → `issues.md`**
- Context to pass: PRD + `docs/prd_digest.md` + `docs/requirements.md` + `docs/ux_spec.md` + `docs/architecture.md` + `docs/data_model.md` + recalled **review lessons** (native memory; passed in your prompt when you run as a subagent)
