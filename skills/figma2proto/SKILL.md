...
allowed-tools: Task, Read, Glob, Grep, Write, Edit, Bash(bash scripts/kit_update_check.py *), Bash(python3 scripts/*), WebSearch, WebFetch, Bash(bash ${CLAUDE_PLUGIN_ROOT}/scripts/*), Bash(python3 ${CLAUDE_PLUGIN_ROOT}/scripts/*)
---
